...
export default function Footer() {
  ...
  const footerLinks = [
    {
      ...
      links: [
        "footer.platformLink1",
        "footer.platformLink2",
        "footer.platformLink3",
        "footer.platformLink4",
      ],
    },
    {
      titleKey: "footer.resourcesTitle",
      links: [
        "footer.resourceLink1",
        "footer.resourceLink2",
        "footer.resourceLink3",
        "footer.resourceLink4",
      ],
    },
    {
  ...
  return (
    <footer className="relative border-t border-card-border py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-card-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} ProcurAI. ,
            {t("footer.copyright")}{" "}
          </p>
